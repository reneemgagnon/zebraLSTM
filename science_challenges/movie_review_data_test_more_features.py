...
class SentimentClassifier(nn.Module):
    def __init__(self, vocab_size, embed_dim, hidden_dim, num_layers, num_stripes, num_classes):
        ...
        self.lstm = StripedLSTM(embed_dim, hidden_dim, num_layers, num_stripes, dropout=0.5)
...
test_dataloader = DataLoader(IMDB(split='test'), batch_size=BATCH_SIZE, shuffle=False, collate_fn=collate_batch)
